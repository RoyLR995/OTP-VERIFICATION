...
class otp_verifier(Tk):
    def __init__(self):
        ...
        self.n = str(self.OTP())
        self.client = Client("ACb591ca81530d4e59f20478bd543f1c62", "59044c1cb628f4bde999ee93f1df39b0")
        self.client.messages.create(to=("+91-9959922182"),from_="+12343322171",body=self.n)
...
### Center textboxes
        ...
        self.picture = PhotoImage (file = "pass1.png")
        ...
        self.me=PhotoImage(file="Untitled (1).png")
        self.a=Label(self,image=self.me,fg="#FFFFFF").place(x=820,y=500)
    ...
    def Buttons(self):
        self.submitButtonImage=PhotoImage(file = "sub btn.png")

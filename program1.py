...
class Generate_otp(Tk):
    ...
    def Labels(self):
        ...
        self.simpli_logo = PhotoImage(file = "Untitled (1).png")
        self.d = Label(self, image= self.simpli_logo, fg="white").place(x=830, y= 500 )
    def Buttons(self):
        self.GenerateOTP=PhotoImage(file = "gener.png")
        self.generatebutton = Button(self , image=self.GenerateOTP, command = self.Open, border = 0 )
        self.generatebutton.place(x = 340 ,y = 370)
    def Open(self):
